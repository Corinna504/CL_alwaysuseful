...
% BK - Oct 2009
p =inputParser;
p.addParamValue('minTheta',2,@isnumeric);
p.addParamValue('maxTheta',length(spikeCount)-2,@isnumeric);
p.addParamValue('maxKappa',length(spikeCount)-1,@isnumeric);
p.addParamValue('delta',1,@isnumeric);
p.addParamValue('responseSign',0,@(x) (ismember(x,[-1 0 1])));
