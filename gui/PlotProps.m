...
param.axisOpts = {...
    'nonparam area ratio', ...
    'MI', ...
    'gain change', 'additive change', 'additive change (rel)', 'gain change (rel)'...
    ...
    'co fit n', 'co fit m',  'rmax drug', 'rmax base', 'rmax diff', ...
    ...
    'signal correlation diff',  'wave width', ...
    'experiment time', ...
...
param.electrodecrit = {'all', 'broken only', 'unbroken only', 'neg volt'};
