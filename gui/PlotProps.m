...
param.axisOpts = {...
    ...
    'hn gauss fit mu base', 'hn gauss fit mu drug', 'hn gauss fit mu diff', ...
    'hn gauss fit sig base', 'hn gauss fit sig drug', 'hn gauss fit sig diff', ...
    'hn gauss fit a base', 'hn gauss fit a drug', 'hn gauss fit a diff', ...
    'hn gauss fit off base', 'hn gauss fit off drug', 'hn gauss fit off diff', ...
